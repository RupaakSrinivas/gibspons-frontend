  ...
  return (
    <div className="fixed h-[64px] top-0 left-0 w-full bg-white text-xl text-black flex flex-row justify-between px-8 align-middle items-center">
        ...
        <div className="flex flex-row justify-center items-center text-xl ">
            <Link href="/home" className="hover:bg-gray-200 rounded-full p-2">
                <p className="px-4">Home</p>
            </Link>
            <Link href="https://dscvit.com" className="hover:bg-gray-200 rounded-full p-2">
                <p className="px-4">About GDSC</p>
            </Link>
            <Link href="/product" className="hover:bg-gray-200 rounded-full p-2">
                <p className="px-4">Product</p>
            </Link>
            <Link href="/blogs" className="hover:bg-gray-200 rounded-full p-2">
                <p className="px-4">Blogs</p>
            </Link>
            <Link href="/login" className="hover:scale-110">
                <p className="px-4 ml-4 py-2 text-white bg-black rounded-full">Get Started</p>
            </Link>
        </div>
    </div>
  );
